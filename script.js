document.addEventListener('DOMContentLoaded', function() {
    ...
    function processData() {
        ...
        sortTableByTime(rosterBodyDom);
        sortTableByTime(rosterBodyInt);
        ...
        newTab.document.write(`
            ...
            <head>
                ...
                <style>
                    ...
                    .pdf-header h1 { font-size: 24px; font-weight: 800; margin: 0 0 5px 0; text-transform: uppercase; color: #000; }
                    .pdf-header h2 { font-size: 16px; font-weight: bold; margin: 0; }
